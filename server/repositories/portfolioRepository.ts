...
const fallbackProjects: Project[] = [
  ...
  { id: 6, slug: "iot-environmental-monitor", title: "IoT Environmental Monitoring Node", summary: "A hardware-software telemetry mini project monitoring temperature, humidity, and ambient metrics via sensors connected to microcontrollers with automated threshold logging.", category: "IoT Systems", techStack: JSON.stringify(["ESP32", "Embedded C", "DHT11 Sensor", "IoT Protocols"]), liveUrl: null, repoUrl: "https://github.com/RootGokul-404", featured: false, sortOrder: 6, createdAt: new Date(), updatedAt: new Date() },
];
