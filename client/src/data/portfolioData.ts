  ...
  projects: [
    {
      ...
      summary: "A connected farming concept designed to bring sensor-informed decisions into day-to-day agricultural operations.",
    ...
    },
    {
      ...
      summary: "An automation-focused parking system concept exploring more efficient vehicle flow and space utilization.",
      category: "Automation",
      techStack: ["Java", "Automation", "System Design"],
      liveUrl: "",
      repoUrl: "https://github.com/RootGokul-404",
      featured: true,
      sortOrder: 2,
    },
    {
      ...
      summary: "A Java-based booking application structured around core ride-request and scheduling workflows.",
      category: "Application Development",
      techStack: ["Java", "OOP", "SQL"],
      liveUrl: "",
      repoUrl: "https://github.com/RootGokul-404",
      featured: true,
      sortOrder: 3,
    },
    {
      ...
      summary: "An ESP32 and Blynk mini project for lightweight alarm automation and remote control experimentation.",
      category: "Embedded Systems",
      techStack: ["ESP32", "Blynk", "Embedded C"],
      liveUrl: "",
      repoUrl: "https://github.com/RootGokul-404",
      featured: false,
      sortOrder: 4,
